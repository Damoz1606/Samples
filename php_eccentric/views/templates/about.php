        ...
        <div class="row middle-grids">
            <div class="col-lg-7 advantage-grid-info">
                <div class="advantage_left">
                    ...
                    <a href="index.php?action=about" class="btn-style btn-primary btn mt-lg-5 mt-4">Download CV</a>
                    <a href="index.php?action=contact" class="btn-style btn-secondary btn mt-lg-5 mt-4 ml-1">Hire Me</a>
                </div>
            </div>
