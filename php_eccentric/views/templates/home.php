<section class="w3l-main-banner">
    <div class="banner-view">
        <div class="banner-info container">
            ...
            <a href="index.php?action=home" class="btn btn-light btn-style mr-3">My Work</a>
            <a href="index.php?action=about" class="btn btn-outline-light btn-style">Hire Me</a>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 content-left mt-lg-0 mt-5 ">
                    ...
                    <a href="index.php?action=about" class="btn-style btn-primary btn mt-lg-5 mt-4">About Me</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-lg-5">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="index.php?action=home" class="btn-style btn-primary btn mt-lg-5 mt-4">View my project</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 mt-lg-0 mt-4">
                ...
                <div class="img-block mt-3">
                    <a href="index.php?action=home"> <img src="assets/images/g2.jpg" class="img-fluid" alt="image" />
...
<section class="w3l-grid-quote py-5">
    <div class="container py-lg-3">
        ...
        <a href="index.php?action=contact" class="btn-style btn-primary btn">Get quotes</a>
        <a href="index.php?action=contact" class="btn btn-style btn-light ml-2">Hire me</a>
    </div>
</section>